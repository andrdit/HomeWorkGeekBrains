...
public class Protocol {
    ...
    public static String getChangeNickname(String login, String password, String newLogin) {
        return USER_CHANGE_NICKNAME + DELIMITER + login + DELIMITER + password + DELIMITER + newLogin;
    }

    public static String getTypeForUser(String src, String message) {
        return FOR_USER + DELIMITER + message;
    }
}
