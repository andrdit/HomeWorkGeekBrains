...
public class Protocol {
    ...
    public static final String USER_CHANGE_LOGIN = "/user_change_login";
    ...
    public static String getChangeNickname(String login, String password) {
        return USER_CHANGE_LOGIN + DELIMITER + login + DELIMITER + password;
    }
}
